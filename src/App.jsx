...
function App() {
  ...
  useEffect(() => {
    ...
    const scroll = document.querySelectorAll(".scroll-down");
    scroll.forEach(val => {
    ...
    <>
      <main className="sfu_img">
        <section className="myHidden first">
          ...
          <div className="sticky top-2 info">
          ...
          <div class="scroll-down mt-8 cursor-pointer"><p>Scroll down</p> <div class="arrow"></div> </div>
        </section>
      </main>
      ...
      <section className="myHidden">
        ...
        <div className="sticky top-2 logos">
      ...
      <section className="myHidden">
        ...
        <div className='infogit flex items-center justify-between'>
